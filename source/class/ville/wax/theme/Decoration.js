...
qx.Theme.define("ville.wax.theme.Decoration",
{
  ...
  decorations :
  {
    ...
    "page-button-right-info" :
    {
      include: "page-button-right",
      
      style :
      {
        backgroundImage: 'data:image/svg+xml,<svg fill="black" width="40px" height="24px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.5 8.91a.5.5 0 0 0-1 .09v4.6a.5.5 0 0 0 1-.1V8.91Zm.3-2.16a.75.75 0 1 0-1.5 0 .75.75 0 0 0 1.5 0ZM18 10a8 8 0 1 0-16 0 8 8 0 0 0 16 0ZM3 10a7 7 0 1 1 14 0 7 7 0 0 1-14 0Z" fill="black"></path></svg>'
      }
    },
